            ...
            subTopics = listOf(
                ...
                SubTopic(
                    ...
                    listOf(
                        ...
                        "def:external:kick::הגנה נגד בעיטת ברך",
                        "def:external:kick::הגנה נגד בעיטה רגילה - עצירה ברגל הקדמית",
                        "def:external:kick::הגנה נגד בעיטה רגילה - עצירה ברגל האחורית",
                        ...
                        "def:external:kick::הגנה נגד בעיטת מגל לפנים באמות הידיים",
                        "def:external:kick::הגנות חיצוניות - הגנה חיצונית נגד בעיטת מגל לפנים - אגרוף בימין",
                        "def:external:kick::בעיטת עצירה נגד בעיטת מגל - עצירה ברגל האחורית",
                        "def:external:kick::בעיטת עצירה נגד בעיטת מגל - עצירה ברגל הקדמית",
                        "def:external:kick::בעיטת עצירה נגד בעיטה לצד"
                    )
                ),
                SubTopic(
                    "הגנות נגד סכין",
