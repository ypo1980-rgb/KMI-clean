...
fun WeakPointsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // ⚠️ אזהרה קבועה מתחת ל־KmiTopBar
            SafetyWarningCard(
                isEnglish = isEnglish,
                text = tr(
                    "אזהרה: פגיעה בנקודות תורפה\nעלולה לגרום לנזק חמור. ⚠️",
                    "Warning: Weak-point strikes\nmay cause severe harm. ⚠️"
                )
            )
            ...
            Column(
                ...
                WeakPointRow(
                    ...
                    bodyPart = tr("ראש", "Head"),
                    effect = tr(
                        "קריעת עור התוף – דימום.",
                        "A ruptured eardrum may cause bleeding."
                    ),
                    isEnglish = isEnglish
                )
                WeakPointRow(
                ...
                WeakPointRow(
                    ...
                    bodyPart = tr("חלק תחתון", "Lower Body"),
                    effect = tr(
                        "האדם לא יכול לשבת (משם ומטה).",
                        "Injury prevents sitting normally."
                    ),
                    isEnglish = isEnglish
                )
                WeakPointRow(
...
private fun createWeakPointsPdf(
    ...
    val items = listOf(
        WeakPointPdfItem(
            tr("מפרקים / אצבעות", "Joints / Fingers"),
            tr("מפרקים", "Joints"),
            tr("כללי", "General"),
            tr(
                "כל תנועה כנגד כיוון לתנועה הטבעית – שבר.",
                "Any movement against the natural direction may cause a fracture."
            )
        ),
        WeakPointPdfItem(
            tr("מפרקים / אצבעות", "Joints / Fingers"),
            tr("שבר באצבע", "Finger Fracture"),
            tr("כללי", "General"),
            tr("אדם מתעלף במקום.", "A severe finger break may cause collapse from pain.")
        ),
        ...
        WeakPointPdfItem(
            ...
            tr(
                "נקודה רגישה – דימום יכול לרדת לעיניים ולפגוע בראייה.",
                "A sensitive point – bleeding may affect vision."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            ...
            tr(
                "פגיעה בעין גורמת לנזק חמור/עיוורון אפשרי.",
                "A strike to the eye may cause severe injury or blindness."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("גשר האף / שורש האף", "Nasal Bridge / Nose Root"),
            tr("ראש", "Head"),
            tr(
                "פגיעה באף יכולה לגרום לדמעות/דימום ועד שבר עצם האף וזעזוע מוח.",
                "A strike to the nose may cause tearing, bleeding, fracture or concussion."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("שורש האף / שפה תחתונה מתחת לאף", "Nose Root / Upper Lip"),
            tr("ראש", "Head"),
            tr(
                "נקודה להוצאה משיווי משקל ע״י הרמת שורש האף.",
                "A control point that can break balance."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("לסת עליונה", "Upper Jaw"),
            tr("ראש", "Head"),
            tr("ניתן לשבור שיניים בקלות יחסית ע״י מכה.", "Teeth may break relatively easily.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("שפתיים", "Lips"),
            tr("ראש", "Head"),
            tr("השפה עלולה להיפצע ע״י השיניים.", "The lips may be cut by the teeth.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("לסת פתוחה", "Open Jaw"),
            tr("ראש", "Head"),
            tr("קל יותר לשבור ע״י מכה.", "Easier to break when open.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("לסת סגורה", "Closed Jaw"),
            tr("ראש", "Head"),
            tr("זעזוע – קשה יותר לשבור.", "May cause shock; harder to break.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("גרוגרת", "Throat"),
        ...
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("שקע הגרוגרת", "Throat Hollow"),
            tr("ראש", "Head"),
            tr("דימום קל/כאב למספר שניות.", "May cause brief pain or minor bleeding.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("עצם הבריח", "Clavicle"),
            tr("חלק עליון", "Upper Body"),
            tr(
                "שבר יכול לשתק את הצד ולמנוע תנועת יד בצורה תקינה.",
                "A fracture can disable normal arm movement."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("בית החזה", "Chest"),
            tr("פנימי", "Internal"),
            tr("שבר בצלעות יכול לגרום לקרע בריאה.", "Broken ribs may puncture the lung.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("כבד", "Liver"),
            tr("פנימי", "Internal"),
            tr("שבר בצלעות יכול לגרום לקרע בכבד.", "Broken ribs may cause liver rupture.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("מפתח הלב", "Solar Plexus"),
            tr("פנימי", "Internal"),
            tr(
                "פגיעה קשה מאוד – סכנת חיים.",
                "A very dangerous strike – potentially life-threatening."
        ...
        WeakPointPdfItem(
            ...
            tr("כליות", "Kidneys"),
            tr("פנימי", "Internal"),
            tr("פגיעה בכליה – נזק משמעותי אפשרי.", "A kidney strike may cause serious damage.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("בטן", "Abdomen"),
            tr("פנימי", "Internal"),
            tr("פגיעה יכולה לגרום לשטף דם פנימי.", "A strike may cause internal bleeding.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("אשכים", "Groin"),
            tr("חלק תחתון", "Lower Body"),
            tr(
                "נקודה חלשה מאוד – תגובת כאב חריפה.",
                "A very vulnerable point causing intense pain."
            )
        ...
        WeakPointPdfItem(
            ...
            tr("פיקה (ברך)", "Kneecap"),
            tr("חלק תחתון", "Lower Body"),
            tr("ניתן לרסק/לגרום לנזק – נכות אפשרית.", "Can be damaged – possible disability.")
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("שוק הרגל", "Shin"),
            ...
            tr(
                "עצם חשופה יחסית – כאב משמעותי מפגיעה.",
                "Exposed bone – significant pain from impact."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            tr("גב כף הרגל", "Top of the Foot"),
            tr("חלק תחתון", "Lower Body"),
            tr(
                "מבנה עדין – בדריכה הנזק יכול להיות גדול.",
                "Delicate structure – stepping may cause serious damage."
            )
        ),
        WeakPointPdfItem(
            tr("חזית", "Front"),
            ...
            tr(
                "פגיעה בשריר/כלי דם גורמת כאב ופגיעה בתפקוד.",
                "Muscle or vessel damage causes pain and reduced function."
            )
        ),

        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("פגיעה ברקה", "Temple"),
            tr("ראש", "Head"),
            tr("פגיעה מסוכנת מאוד.", "A highly dangerous impact point.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("אוזן", "Ear"),
            tr("ראש", "Head"),
            tr("קריעת עור התוף – דימום.", "A ruptured eardrum may cause bleeding.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("צואר", "Neck"),
            tr("ראש", "Head"),
            tr(
                "פגיעה בכלי דם: עילפון; חניקה ממושכת – סכנת חיים.",
                "Blood-vessel strike may cause collapse; prolonged choking is life-threatening."
            )
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("כתף", "Shoulder"),
            tr("חלק עליון", "Upper Body"),
            tr("ניתן להוציא מהמקום ע״י הוצאת העצם מהשקע.", "Can be dislocated from the socket.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("בית השחי", "Armpit"),
            tr("חלק עליון", "Upper Body"),
            tr("שריר רגיש מאוד – פגיעה כואבת מאוד.", "Very sensitive muscle area.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("צלעות", "Ribs"),
            tr("חלק עליון", "Upper Body"),
            tr("פגיעה בעצב גורמת כאב חזק.", "Nerve impact causes strong pain.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("שבירת צלעות", "Broken Ribs"),
            tr("חלק עליון", "Upper Body"),
            tr("גרימת קרע בריאה – אפילו מוות.", "May cause lung rupture – potentially fatal.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("שקע הברך מהצד", "Side of Knee Joint"),
            tr("חלק תחתון", "Lower Body"),
            tr("קל לגרום לקרע ברצועות.", "Easy to damage ligaments.")
        ),
        WeakPointPdfItem(
            tr("צד", "Side"),
            tr("קרסול", "Ankle"),
            tr("חלק תחתון", "Lower Body"),
            tr(
                "פגיעה נכונה יכולה לפגוע בקרסול ולהקשות על הליכה.",
                "Can damage the ankle and make walking difficult."
            )
        ),

        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("מוח גדול", "Cerebrum"),
            tr("ראש", "Head"),
            tr("העצבים בגוף (אינסטינקט).", "Controls body nerves and instinctive reactions.")
        ),
        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("מוח קטן", "Cerebellum"),
            tr("ראש", "Head"),
            tr(
                "שיווי משקל – פגיעה גורמת לאיבוד שיווי משקל.",
                "Responsible for balance – impact may cause loss of balance."
            )
        ),
        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("שבירת מפרקת", "Neck Break"),
            tr("ראש / צוואר", "Head / Neck"),
            tr("מוות מיידי.", "Immediate death.")
        ),
        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("פגיעה בחוליות", "Vertebrae"),
            tr("חלק עליון", "Upper Body"),
            tr("נזק למפרקת.", "Damage to the cervical spine.")
        ),
        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("עמוד השדרה", "Spine"),
            tr("חלק עליון", "Upper Body"),
            tr("בנוי מחוליות – קשה לגרום לשבר.", "Built from vertebrae – difficult to break.")
        ),
        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("עצם הזנב", "Tailbone"),
            tr("חלק תחתון", "Lower Body"),
            tr("האדם לא יכול לשבת בצורה תקינה.", "Injury prevents normal sitting.")
        ),
        WeakPointPdfItem(
            tr("מאחור", "Back"),
            tr("גיד אכילס", "Achilles Tendon"),
            tr("חלק תחתון", "Lower Body"),
            tr(
                "פגיעה ואי אפשר להזיז את העקב למעלה/למטה.",
                "Damage prevents moving the heel up or down."
    ...
    while (itemIndex < items.size) {
        ...
        if (pageNumber == 1) {
            ...
            canvas.drawText(
                tr("אזהרת בטיחות", "Safety Warning"),
            ...
            canvas.drawText(
                tr(
                    "אין לתרגל ללא פיקוח מאמן מוסמך וציוד בטיחות מתאים.",
                    "Do not practice without certified supervision and proper safety equipment."
                ),
                pageWidth - margin - 22f,
                y + 56f,
                valuePaint
        ...
        canvas.drawText(
            tr("פירוט נקודות מרכזיות", "Key Points Summary"),
            pageWidth / 2f,
            y,
            sectionPaint
        )
