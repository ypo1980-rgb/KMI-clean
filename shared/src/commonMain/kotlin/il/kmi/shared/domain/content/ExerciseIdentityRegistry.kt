...
object ExerciseIdentityRegistry {
    ...
    val knownExercises: List<ExerciseIdentity> = listOf(
        ...
        ExerciseIdentity(
            ...
            topicKeys = setOf(
                "עבודת ידיים",
                "עבודת ידיים__מגל + סנוקרת",
                /*
           * המפתחות הישנים נשמרים לתאימות עם
           * חיפוש, זיכרון ונתונים קיימים.
           */
        ...
        // ==========================================================================
        // ================= חגורה כתומה — תרגילים ex_072 עד ex_149 =========        // ========== חגורה כתומה — 80 תרגילים: ex_072 עד ex_149 + ex_396 עד ex_397 ==================
        // ==========================================================================
        ...
        ExerciseIdentity(
            id = "ex_396",
            belt = Belt.ORANGE,
            hebrewTitle = "שחרור מחביקה סגורה מלפנים",
            topicKeys = setOf(
                "שחרורים",
                "שחרורים__שחרורים מחביקות צואר וגוף",
        ...
        ExerciseIdentity(
            id = "ex_397",
            belt = Belt.ORANGE,
            hebrewTitle = "שחרור מחביקה סגורה מאחור",
            topicKeys = setOf(
                "שחרורים",
                "שחרורים__שחרורים מחביקות צואר וגוף",
                "שחרורים מחביקות צואר וגוף",
