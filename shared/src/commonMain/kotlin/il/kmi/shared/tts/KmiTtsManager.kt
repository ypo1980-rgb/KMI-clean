...
object KmiTtsManager {
     ...
     */
    private const val TTS_CACHE_VERSION = "chirp3_he_v6"
    ...
    private fun normalizeForTts(
        ...
        return text
             ...
             */
            /*
             * כתיב פונטי שמכריח את מנוע ההקראה
             * לבטא SHEL-CHA בלשון זכר.
             *
             * השינוי קיים רק בקובץ הקול ואינו משנה
             * את המילה "שלך" שמוצגת למשתמש.
             */
            .replace(
                Regex("""(?<![א-ת])שלך(?![א-ת])"""),
                "שֶלְכָה"
