...
object SubTopicRegistry {
    ...
    private val dataSubTopics: Map<Belt, Map<String, List<String>>> = mapOf(
        ...
        Belt.YELLOW to mapOf(
            "שחרורים" to listOf(
                "שחרור מאחיזת צואר צד",
                "שחרור מאחיזת צואר קדמית"
            )
        ),
        Belt.GREEN to mapOf(
            "שחרורים" to listOf(
                "שחרור מאחיזת צואר צד",
                "שחרור מאחיזת צואר אחורית"
            )
        )
    ...
    private val dataItems: Map<Belt, Map<String, Map<String, List<String>>>> = mapOf(
        Belt.YELLOW to mapOf(
            "שחרורים" to mapOf(
                "שחרור מאחיזת צואר צד" to listOf(
                    "שחרור מאחיזת צואר צד – שלב 1",
                    "שחרור מאחיזת צואר צד – שלב 2",
                    "שחרור מאחיזת צואר צד – סיום"
                ),
                "שחרור מאחיזת צואר קדמית" to listOf(
                    "שחרור מאחיזת צואר קדמית – דחיפה",
                    "שחרור מאחיזת צואר קדמית – יציאה הצידה"
                )
            )
        ),
        Belt.GREEN to mapOf(
            "שחרורים" to mapOf(
                ...
                // "שחרור מאחיזת צואר אחורית" to listOf(...)
            )
        )
